  ...
  de: {
    ...
    whyMedweg: {
      ...
      callToAction: {
        ...
        facilities: 'Pflegedienste • Ambulante Pflege • Intensivpflege • Kliniken • Altersheime',
    ...
    aboutUs: {
      ...
      ceo: {
        ...
        experienceText: 'Illes Papp bringt langjährige Erfahrung aus der Pflegebranche sowie fundiertes Fachwissen in das Unternehmen MedWeg Bavaria ein. Als erfahrener Krankenpfleger, Pflegedienstleiter und Geschäftsführer vereint er praktische Expertise mit tiefgehender Branchenkenntnis.',
        companyTitle: '',
        companyDescription: '',
        closingText: 'Sein Fokus liegt auf hoher Produktqualität, zuverlässigem Kundenservice und professioneller Beratung rund um medizinische Versorgungsprodukte. Mit seinem Engagement für Qualität und Transparenz setzt Illes Papp klare Maßstäbe und sorgt dafür, dass Kundinnen und Kunden stets die beste Lösung für ihren Bedarf erhalten.',
      },
    },
  ...
  en: {
    ...
    whyMedweg: {
      ...
      callToAction: {
        ...
        facilities: 'Nursing Services • Outpatient Care • Intensive Care • Clinics • Nursing Homes',
    ...
    aboutUs: {
      ...
      ceo: {
        ...
        experienceText: 'Illes Papp brings years of experience from the healthcare industry as well as profound expertise to MedWeg Bavaria. As an experienced nurse, care service manager and CEO, he combines practical expertise with deep industry knowledge.',
        companyTitle: '',
        companyDescription: '',
        closingText: 'His focus is on high product quality, reliable customer service and professional consulting for medical supply products. With his commitment to quality and transparency, Illes Papp sets clear standards and ensures that customers always receive the best solution for their needs.',
      },
    },
